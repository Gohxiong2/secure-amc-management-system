...
try {
    ...
    if ($role === 'admin') {
        ...
        $query = "SELECT s.student_id, s.name AS student_name, s.index_number, c.course_name, sc.status
                  FROM students s
...
<head>
    ...
    <style>
        ...
        th, td {
            padding: 10px;
            text-align: left;
            vertical-align: middle; /* Ensures content stays vertically centered */
        }
        th {
            background-color: #f2f2f2;
        }

        /* Specific styling for the Course Name column */
        td:nth-child(3) { /* Targets the Course Name column */
        ...
        form {
            display: inline-block; /* Prevents form buttons from stacking vertically */
        }
...
<body>
    ...
    <a href="assign_student_courses.php">Assign Student to Courses</a>
